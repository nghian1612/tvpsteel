if (typeof (jQuery) != 'undefined') {
    ...
    (function ($) {
        ...
        $(document.body).on('change', '.wpb-select.theme_style', function () {
            $('.bit14-testimonial-style').attr('src', PBWB_ASSETS_URL + 'images/' + $(this).val() + '.jpg');
        });
    });
        ...
        pb_addons(document).ready(function($) {
            ...
            function addonToggle($btn){
                ...
                var data = {
                    ...
                    plugin: plugin,
                    type  : pluginType,
                    security: pb_data_about.nonce_install
                };
