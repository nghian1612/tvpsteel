		...
		<div class="sfsi_right_info">
			...
			<p>
				...
				<div class="kckslctn" <?php echo $label_style; ?>>
					...
					<p><?php _e( 'Please use the shortcode', 'ultimate-social-media-icons' ); ?> <b><?php echo do_shortcode('[DISPLAY_ULTIMATE_SOCIAL_ICONS]');?></b><?php _e( ' to place the icons anywhere you want.', 'ultimate-social-media-icons' ); ?></p>
