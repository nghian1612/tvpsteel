...
return array(
   'title'      =>__( 'Sidebar Section', 'corporate-blocks' ),
...
<h3 class="has-upper-heading-font-size" style="font-style:normal;font-weight:500">'.esc_html__('Search','corporate-blocks').'</h3>
<!-- /wp:heading -->
...
<div class="wp-block-group has-no-hover-box-shadow" style="margin-bottom:30px"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"upper-heading"} -->
<h3 class="has-upper-heading-font-size" style="font-style:normal;font-weight:500">'.esc_html__('Latest Post','corporate-blocks').'</h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"30px"},"blockGap":"20px"}},"className":"has-no-hover-box-shadow"} -->
<div class="wp-block-group has-no-hover-box-shadow" style="margin-bottom:30px"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"upper-heading"} -->
<h3 class="has-upper-heading-font-size" style="font-style:normal;font-weight:500">'.esc_html__('Category','corporate-blocks').'</h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"30px"},"blockGap":"20px"}},"className":"has-no-hover-box-shadow"} -->
<div class="wp-block-group has-no-hover-box-shadow" style="margin-bottom:30px"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"upper-heading"} -->
<h3 class="has-upper-heading-font-size" style="font-style:normal;font-weight:500">'.esc_html__('social','corporate-blocks').'</h3>
<!-- /wp:heading -->
