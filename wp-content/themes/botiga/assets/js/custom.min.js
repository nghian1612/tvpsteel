...
window.addEventListener('scroll', function() {
    ...
    var aboveHeaderRow = document.querySelector('.bhfb-above_header_row');
    var scrolled = window.pageYOffset || document.documentElement.scrollTop;
  
    if (scrolled > 150) {
      aboveHeaderRow.classList.add('bhfb-header-scrolled');
    } else {
      aboveHeaderRow.classList.remove('bhfb-header-scrolled');
    }
  })